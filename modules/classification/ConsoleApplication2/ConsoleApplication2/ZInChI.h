...
public' :
	CZInChI(void) ~CZInChI(void)
			...
			void Atomclass(void) void Oclass1(void) void OclassO(void) void OclassN(void) void OclassH(void) void OclassP(void) void OclassSi(void) void OclassS(void)

					void OclassNO(void) void OclassOS(void) void Subclass(void)
			...
			// Sub Functions
			void RingCheck(void) void Ringsort(void) void Ringdelete(void) void Unsatbond(int ithAtom) void FIndAtomloc(int ithAtom) double BondCheck(int ithAtom) double Checkhydrogen(int ithAtom) int Countstr(CString string, CString str2)
			...
			CString strSubInChI[20] CString strSubFormula[20] CString strSubConnect[20] CString strSubHydrogen[20] CString strSubCharge[20]

			// Numbers of important atoms
			int iSubMetal[20] int iNumSubCarbon[20] int iNumSubNitrogen[20] int iNumSubOxygen[20] int iNumSubSilicon[20] int iNumSubPhosphine[20] int iNumSubSulfur[20] int iNumSubHydrogen[20] int iNumSubHalogen[20] // Number of Halogen
			...
			int iSubCountAtom[20] int iSubAtom[20][255] int iOrgSub[20]

			// variables for substructure

			int iKindKGuest

			int iAtom[255] int iNumRing // Number of rings
			...
			int ring[255] int ringatom[255][255] int iringNUM[255]

			int iloc[20] int iBond[20] int iUnsatbond[255] int iNumbond[20]

			int iOrCheck[10] int FGs[255] int iMulSub[20] int nstdBond
			int iSubAnion
