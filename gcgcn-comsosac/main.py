...
class CosmoSacGcgcn(CosmoSac):
    sig = models.load_model(opj("models", "gcgcn_sig.h5"), compile=False)
    nhb = models.load_model(opj("models", "gcgcn_nhb.h5"), compile=False)
    oh = models.load_model(opj("models", "gcgcn_oh.h5"), compile=False)
    ot = models.load_model(opj("models", "gcgcn_ot.h5"), compile=False)
    vol = models.load_model(opj("models", "gcgcn_vol.h5"), compile=False)
...
# gcgcn_model.add_comp("CCC")
# gcgcn_model.x = [0.5, 0.5]
